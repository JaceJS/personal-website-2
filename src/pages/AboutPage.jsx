    ...
    <>      
      <div className='mt-16 p-7'>
        <div className='flex flex-col lg:grid lg:grid-cols-3 justify-center items-center mb-12 gap-8 lg:gap-0'>
          <img src="./src/assets/hero.png" alt="hero" data-aos="fade-right" className="w-60 h-60 lg:mb-0 lg:w-full md:h-64 lg:h-96 object-cover object-top lg:object-contain"/>      
